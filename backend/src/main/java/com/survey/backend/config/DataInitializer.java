...
public class DataInitializer {
    ...
    public void init() {
        ...
        List<Question> customerQuestions = List.of(
                Question.builder()
        ...
        // Survey 2
        Survey employeeSurvey = Survey.builder()
                .title("Employee Feedback Survey")
                .createdAt(LocalDateTime.now())
                .build();

        List<Question> employeeQuestions = List.of(
                Question.builder()
        ...
        // Survey 3
        Survey productSurvey = Survey.builder()
                .title("Product Feedback Survey")
                .createdAt(LocalDateTime.now())
                .build();

        List<Question> productQuestions = List.of(
                Question.builder()
